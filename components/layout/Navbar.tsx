  ...
  return (
    <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            <Link href="/" className="flex items-center transition-all duration-300 hover:text-3xl">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-full">
                <div className="flex items-center">
                  ...
                  <SheetTitle className="text-2xl">OpenYan <Button variant="outline">GitHub</Button></SheetTitle>
                </div>
